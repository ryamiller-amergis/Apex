...
can read the bare mirror. Chat and Ask Apex provenance now labels bare-mirror
reads instead of always saying Azure Files. Working-tree services and the six
