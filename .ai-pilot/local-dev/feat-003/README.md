# Local Development Context — Provide ability to select effort per agent module within project settings — Server-Authoritative Effort Resolution at Kickoff

These files belong under your **repository root** at:

```
.ai-pilot/local-dev/feat-003/
```
