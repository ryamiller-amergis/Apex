...
Title: Provide ability to select effort per agent module within project settings — Effort Snapshot on Audit & Cost History
ID: feature FEAT-004 (PRD f1c5f613-3d5d-4f9c-89fc-ddcf8b1c3e23)
Type: Apex Feature

Context files have been extracted under `.ai-pilot/local-dev/feat-004/`. Read them before coding:

- `.ai-pilot/local-dev/feat-004/prd.md`
- `.ai-pilot/local-dev/feat-004/backlog.json`
- `.ai-pilot/local-dev/feat-004/design-spec/design.md`
- `.ai-pilot/local-dev/feat-004/design-spec/tech-spec.md`
- `.ai-pilot/local-dev/feat-004/design-spec/assumptions.md`

## Development skill

This project is configured to use the `/.cursor/skills/dev-orchestrator/SKILL.md` skill. Begin by invoking:

  //.cursor/skills/dev-orchestrator/SKILL.md feature feat-004 FEAT-004

### Local execution policy (overrides Dev Workbench defaults)

- **Artifact root:** `.ai-pilot/local-dev/feat-004/` (not `.ai-pilot/output/`)
