...
| Architecture Decision Records | — | `.cursor/skills/adr-interview/SKILL.md`, `.cursor/skills/adr-finalize/SKILL.md` | `adrService.ts` | `AdrChatView.tsx`, `AdrsDashboard.tsx` |
