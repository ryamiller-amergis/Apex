...
Before recommending an option, inspect the selected repository through available repository tools:

1. Browse the relevant modules and documentation to understand the current state.
2. Search for existing implementations, constraints, and naming conventions.
3. Load any project skill files that define relevant conventions.
