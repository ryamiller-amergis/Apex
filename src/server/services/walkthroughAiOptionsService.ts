...
function mapRow(row: typeof walkthroughAiOptions.$inferSelect): WalkthroughAiOptionsRecord {
  return {
    ...
    anchorDiscoverySkillPath: row.anchorDiscoverySkillPath,
    anchorDiscoveryModel: row.anchorDiscoveryModel ?? '',
...
export async function saveWalkthroughAiOptions(
  ...
  await db
    ...
    .values({
      ...
      anchorDiscoverySkillPath: command.anchorDiscoverySkillPath,
      anchorDiscoveryModel: command.anchorDiscoveryModel ?? '',
      createdBy: actor.id,
