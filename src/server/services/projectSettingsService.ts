...
export async function upsertSkillConfig(
  ...
  const rows = await db
    ...
    .values({
      ...
      uiLabBedrockModelId: uiLabBedrockModelId ?? null,
      uiLabBedrockMaxTokens: uiLabBedrockMaxTokens ?? null,
      uiLabBedrockTimeoutMs: uiLabBedrockTimeoutMs ?? null,
      uiLabRegenBedrockModelId: uiLabRegenBedrockModelId ?? null,
      uiLabRegenBedrockMaxTokens: uiLabRegenBedrockMaxTokens ?? null,
      uiLabBedrockTemperature: uiLabBedrockTemperature ?? null,
      uiLabSkillPath: uiLabSkillPath ?? null,
