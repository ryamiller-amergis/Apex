...
router.get('/skill-config', async (req: Request, res: Response) => {
  try {
    ...
    res.json({
      ...
      requirementsPhaseSkillPath: config.requirementsPhaseSkillPath ?? null,
      requirementsPhaseModel: config.requirementsPhaseModel ?? null,
      technicalPhaseSkillPath: config.technicalPhaseSkillPath ?? null,
      technicalPhaseModel: config.technicalPhaseModel ?? null,
      ...
      requirementsPhaseEffort: config.requirementsPhaseEffort ?? null,
      technicalPhaseEffort: config.technicalPhaseEffort ?? null,
