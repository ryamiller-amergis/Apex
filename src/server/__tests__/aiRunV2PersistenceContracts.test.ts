...
describe('AI-run V2 persistence contracts', () => {
  ...
  it('defines attempt, outbox, inbox, and seeded lease tables', () => {
    ...
    expect(controlPlaneMigration).toMatch(/CREATE TABLE IF NOT EXISTS ai_run_attempts/);
    expect(controlPlaneMigration).toMatch(/CREATE TABLE IF NOT EXISTS ai_run_outbox/);
    expect(controlPlaneMigration).toMatch(/CREATE TABLE IF NOT EXISTS ai_run_inbox/);
    expect(controlPlaneMigration).toMatch(/CREATE TABLE IF NOT EXISTS ai_control_plane_leases/);
    expect(controlPlaneMigration).toMatch(
