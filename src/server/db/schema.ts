...
export const interviews = pgTable('interviews', {
  ...
  phaseFlow: text('phase_flow'),
  requirementsOwnerId: text('requirements_owner_id').references(() => appUsers.oid, { onDelete: 'set null' }),
  technicalOwnerId: text('technical_owner_id').references(() => appUsers.oid, { onDelete: 'set null' }),
  requirementsPhaseStatus: text('requirements_phase_status'),
  technicalPhaseStatus: text('technical_phase_status'),
  requirementsSummary: text('requirements_summary'),
  technicalSummary: text('technical_summary'),
  requirementsApprovedAt: timestamp('requirements_approved_at', { withTimezone: true, mode: 'string' }),
  technicalApprovedAt: timestamp('technical_approved_at', { withTimezone: true, mode: 'string' }),
  technicalPhaseChatThreadId: uuid('technical_phase_chat_thread_id').references(() => chatThreads.id, { onDelete: 'set null' }),
...
export const interviewsRelations = relations(interviews, ({ one, many }) => ({
  ...
  technicalPhaseChatThread: one(chatThreads, {
    relationName: 'interviewTechnicalPhaseChatThread',
    fields: [interviews.technicalPhaseChatThreadId],
    references: [chatThreads.id],
  }),
  ...
  requirementsOwner: one(appUsers, {
    fields: [interviews.requirementsOwnerId],
    references: [appUsers.oid],
    relationName: 'interviewRequirementsOwner',
  }),
  technicalOwner: one(appUsers, {
    fields: [interviews.technicalOwnerId],
    references: [appUsers.oid],
    relationName: 'interviewTechnicalOwner',
  }),
  prds: many(prds),
...
export const projectSkillSettings = pgTable('project_skill_settings', {
  ...
  technicalPhaseSkillPath: text('technical_phase_skill_path'),
  technicalPhaseModel: text('technical_phase_model'),
  technicalPhaseEffort: text('technical_phase_effort').$type<EffortLevel>(),
  requirementsPhaseSkillPath: text('requirements_phase_skill_path'),
  requirementsPhaseModel: text('requirements_phase_model'),
  requirementsPhaseEffort: text('requirements_phase_effort').$type<EffortLevel>(),
