-- Up Migration
-- Seed the rfp-intake kill switch so the landing "Request a Product" cards
-- and Apex RFP Intake queue are reachable after foundations/menu migrations.
-- Platform Admin can still turn Enabled off. Idempotent.
